...
10. In a browser window, enter **http://<public_ip>** or **https://<public_ip>** (of course replacing '<public_ip>' with the actual IP from your instance. If using https, ignore the "Page is not secure" warning. The sample html test page named 'Dickson Kimani Assignment' is dispalyed.
